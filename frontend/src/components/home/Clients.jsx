...
export default function Clients() {
  ...
  const track = useMemo(() => {
    ...
    const lap = Array.from({ length: repeat }, () => clients).flat();
  ...
  // The section (and its #clients anchor) always mounts, even before the
  // fetch above resolves — otherwise the header nav link has nothing to
  // scroll to yet and the jump silently does nothing.
  return (
