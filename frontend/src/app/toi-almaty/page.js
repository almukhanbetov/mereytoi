...
export const metadata = {
  title: "Организация той в Алматы | MEREYTOI",
  description:
    "Организация той в Алматы под ключ: площадка, ведущий, декор, шоу-программа, артисты, фото и видео. Полная координация мероприятия от MEREYTOI.",
  alternates: {
    canonical: "https://mereytoi.kz/toi-almaty",
  },
};
...
const INCLUDES = [
  {
    ...
    descRu: "Банкетные залы и локации в Алматы под любой формат и число гостей.",
    descKz: "Кез келген форматқа және қонақтар санына сай Алматыдағы банкет залдары мен алаңдар.",
  },
  {
    ru: "Ведущий", kz: "Жүргізуші",
    descRu: "Опытные ведущие для той, юбилея или корпоратива на казахском и русском языках.",
    descKz: "Той, мерейтой немесе корпоративке арналған тәжірибелі жүргізушілер, қазақ және орыс тілдерінде.",
  },
  {
    ru: "Декор", kz: "Декор",
  ...
  },
  {
    ...
    descRu: "Файер-шоу, лазерные и другие форматы для вечерней части мероприятия.",
    descKz: "Іс-шараның кешкі бөлігіне арналған от-шоу, лазерлік және басқа форматтар.",
  },
  {
    ru: "Артисты", kz: "Әртістер",
    descRu: "Музыкальные коллективы, вокалисты и DJ для любой атмосферы праздника.",
    descKz: "Мерекенің кез келген атмосферасына арналған музыкалық топтар, әншілер және DJ.",
  },
  {
  ...
  },
  {
    ...
    descRu: "Сопровождение в день той — контролируем тайминг и все службы.",
...
const EVENT_TYPES = [
  { icon: "💍", ru: "Свадебный той", kz: "Үйлену тойы" },
  { icon: "🎉", ru: "Юбилей", kz: "Мерейтой" },
  { icon: "👨‍👩‍👧‍👦", ru: "Семейное торжество", kz: "Отбасылық мереке" },
  { icon: "🥂", ru: "Корпоратив", kz: "Корпоратив" },
  { icon: "✨", ru: "Другие праздничные мероприятия", kz: "Басқа мерекелік іс-шаралар" },
];
...
const FAQ = [
  {
    qRu: "Сколько стоит организация той в Алматы?",
    qKz: "Той ұйымдастыру Алматыда қанша тұрады?",
  ...
  },
  {
    ...
    aRu: "Да, можно выбрать как полную организацию, так и отдельные услуги — например, только ведущего или декор.",
    aKz: "Иә, толық ұйымдастыруды да, жеке қызметтерді де (мысалы, тек жүргізуші немесе декор) таңдауға болады.",
  },
  {
    qRu: "Помогаете ли вы подобрать площадку?",
    qKz: "Алаң таңдауға көмектесесіздер ме?",
    aRu: "Да, помогаем подобрать банкетный зал или локацию, подходящую по вместимости и формату мероприятия.",
    aKz: "Иә, іс-шараның форматы мен қонақтар санына сай банкет залын немесе алаңды таңдауға көмектесеміз.",
  },
  {
    qRu: "Можно ли заказать ведущего, артистов и шоу-программу отдельно?",
    qKz: "Жүргізуші, әртістер және шоу-бағдарламаны бөлек тапсырыс беруге бола ма?",
    aRu: "Да, эти услуги можно заказать по отдельности через каталог услуг или в рамках полной организации той.",
    aKz: "Иә, бұл қызметтерді қызметтер каталогы арқылы бөлек немесе той ұйымдастырудың құрамында тапсырыс беруге болады.",
  },
  {
    qRu: "Как начать подготовку мероприятия?",
    qKz: "Дайындықты қалай бастауға болады?",
...
export default function ToiAlmatyPage() {
  return (
    <>
      <section className="page-hero" style={{ paddingBottom: 70 }}>
        ...
        <div className="container">
          <p className="breadcrumb">
            ...
            <span>/</span>
            <span className="is-current"><T ru="Организация той в Алматы" kz="Алматыда той ұйымдастыру" /></span>
          </p>
          <h1><T ru="Организация той в Алматы" kz="Алматыда той ұйымдастыру" /></h1>
          <p>
            <T
              ru="Берём на себя подготовку мероприятия: площадка, ведущий, декор, шоу-программа, артисты, фото и видео — от идеи до дня проведения."
              kz="Іс-шараны толық дайындауға көмектесеміз: алаң, жүргізуші, декор, шоу-бағдарлама, әртістер, фото және видео — идеядан той күніне дейін."
            />
          </p>
      ...
      {/* Section A — Организация той под ключ */}
      <section className="toi-section">
        <div className="container toi-section__intro">
          ...
          <Reveal as="h2" className="section-title"><T ru="Организация той под ключ" kz="Тойды толық ұйымдастыру" /></Reveal>
          <Reveal as="p" className="section-desc">
            <T
              ru="MEREYTOI берёт на себя координацию тоя в Алматы — от первой идеи до дня мероприятия. Помогаем определить концепцию праздника, подобрать площадку, ведущего и артистов, продумать программу и декор, организовать фото- и видеосъёмку и держим под контролем каждую деталь подготовки."
              kz="MEREYTOI Алматыдағы тойды үйлестіруге алады — алғашқы идеядан той күніне дейін. Мерекенің тұжырымдамасын анықтауға, алаң, жүргізуші және әртістерді таңдауға, бағдарлама мен декорды ойластыруға, фото және видео түсірілімді ұйымдастыруға көмектесеміз және дайындықтың әр бөлшегін бақылауда ұстаймыз."
            />
          </Reveal>
        </div>
      </section>

      {/* Section B — Что входит в организацию */}
      <section className="toi-section toi-section--alt">
        <div className="container">
          ...
          <Reveal as="h2" className="section-title"><T ru="Что входит в организацию" kz="Ұйымдастыруға не кіреді" /></Reveal>
          ...
          <Reveal className="services__cta">
            <Link href="/services" className="btn btn--outline">
              <T ru="Посмотреть услуги для организации той" kz="Той ұйымдастыруға арналған қызметтерді көру" />
            </Link>
          </Reveal>
        </div>
      </section>
      ...
      {/* Section D — Для каких мероприятий */}
      <section className="toi-section toi-section--alt">
        <div className="container toi-section__intro">
          <Reveal as="p" className="section-eyebrow"><T ru="ФОРМАТЫ" kz="ФОРМАТТАР" /></Reveal>
          <Reveal as="h2" className="section-title"><T ru="Для каких мероприятий" kz="Қандай іс-шараларға" /></Reveal>
          <Reveal as="ul" className="contacts__list" style={{ marginTop: 34, textAlign: 'left', display: 'inline-flex', flexDirection: 'column' }}>
            {EVENT_TYPES.map((et) => (
              <li key={et.ru}>
                <span className="contacts__icon">{et.icon}</span>
                <span><T ru={et.ru} kz={et.kz} /></span>
              </li>
            ))}
          </Reveal>
        </div>
      ...
      <section className="toi-section toi-section--alt">
        <div className="container toi-section__intro">
          <Reveal as="h2" className="section-title"><T ru="Планируете той в Алматы?" kz="Алматыда той жоспарлап жатырсыз ба?" /></Reveal>
          <Reveal as="p" className="section-desc">
            <T
              ru="Подберём подходящие услуги и поможем собрать программу мероприятия."
              kz="Қажетті қызметтерді таңдап, іс-шара бағдарламасын құруға көмектесеміз."
            />
          </Reveal>
